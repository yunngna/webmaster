				...
				<div class="board-write">
					...
					<div class="form-group row">
						...
						<div class="form-control-body">
							<input class="form-control" type="password" id="ckPasswd"
								name="ckPasswd" title="비밀번호를 입력해 주세요.">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="form-control-body">
								<div class="col-xs-2">
									<input class="form-control w-25" type="text" id="zip"
										name="zip"> <a href="javascript:void(0);"
										onclick="sample3_execDaumPostcode('zip','add1');"
										class="btn-d">우편번호 찾기</a>
								</div>
								<input class="form-control" type="text" id="add1"
									name="address1">
								<pre></pre>
								<input class="form-control" type="text" id="add2"
